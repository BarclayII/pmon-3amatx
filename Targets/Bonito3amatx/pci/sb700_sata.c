...
static void sata_init(device_t dev)
{
	...
	pci_write_config32(dev, 0x88, 0x01B48013);
	pci_write_config32(dev, 0x8c, 0x01B48013);
	pci_write_config32(dev, 0x90, 0x01B48013);
	pci_write_config32(dev, 0x94, 0x01B48013);
	pci_write_config32(dev, 0x98, 0x01B48013);
	pci_write_config32(dev, 0x9C, 0x01B48014);
